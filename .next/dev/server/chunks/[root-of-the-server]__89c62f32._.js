...
async function GET() {
    try {
        ...
        const { data: producto, error: errorProducto } = await supabase.from("productos").select("*").eq("id", PRODUCTO_ID).single();
        if (errorProducto) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__89c62f32._.js.map