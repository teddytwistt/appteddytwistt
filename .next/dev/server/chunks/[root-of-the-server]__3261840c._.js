...
"[project]/app/api/get-prices/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { data: producto, error } = await supabase.from("productos").select("precio_cba, precio_interior").eq("id", PRODUCTO_ID).single();
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3261840c._.js.map