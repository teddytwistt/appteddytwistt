-- =====================================================
-- SCRIPT LIMPIO - SIN MIGRACIÓN DE DATOS
-- =====================================================
-- Este script ELIMINA las tablas antiguas y crea todo nuevo
-- =====================================================
...
-- Eliminar triggers y funciones antiguas
...
CREATE INDEX idx_codigos_descuento_activo ON codigos_descuento(activo);
...
SELECT generate_series(1, 900), 'disponible';

CREATE INDEX idx_numeros_serie_estado ON numeros_serie(estado);
CREATE INDEX idx_numeros_serie_pedido ON numeros_serie(id_pedido);
...
CREATE INDEX idx_pedidos_id_interno ON pedidos(id_interno);
...
CREATE INDEX idx_pedidos_estado_envio ON pedidos(estado_envio);
CREATE INDEX idx_pedidos_producto ON pedidos(id_producto);
CREATE INDEX idx_pedidos_descuento ON pedidos(id_codigo_descuento);
...
CREATE VIEW vista_uso_descuentos AS
SELECT
  cd.id,
  cd.codigo,
...
UNION ALL
SELECT 'Números de serie', COUNT(*) FROM numeros_serie
UNION ALL
SELECT 'Pedidos', COUNT(*) FROM pedidos;

SELECT '✅ BASE DE DATOS CREADA DESDE CERO' as estado;
